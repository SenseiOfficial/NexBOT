...
OFFICIAL_UPSTREAM_REPO = "https://github.com/SenseiOfficial/NexBOT"
BOT_IS_UP_TO_DATE = "❂NexBOT is up-to-date!❂"
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("**﹁﹁NexBOT* \n**Version** : `2.0` \n**Telethon** : `1.15.0` \n**Status** : `«Pulling Updates»` \n『**Thank You For Using NexBOT !**』")
